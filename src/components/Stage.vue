<template>
    <div @click="data.editorData.detailStageId = stage.id" class="contents">
        <div :style="{opacity: data.editorData.detailStageId === stage.id ? 1 : 0.5}" class="flex gap-2 items-center py-2">
...
const { data, requestDependencies } = inject('injectGlobalState')
